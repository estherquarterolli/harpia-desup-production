...
def get_contract_id(cargo):
    ...
    if 'INSTRUTOR' in cargo:                return 6  # 'Instrutor' foi removido; mapeia para Contratado 40h
...
emit(f"SELECT setval('professors_contracttype_id_seq', {max(c[0] for c in CONTRACT_TYPES)});")
emit()
